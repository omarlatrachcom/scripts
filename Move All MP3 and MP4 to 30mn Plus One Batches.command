...
# Standalone automatic mover. It contains its complete implementation and does
# not call another command or a support script.

MAX_SECONDS=1800
MAX_DURATION_LABEL="30mn"
EXTRA_ITEM_STRICT_LIMIT=3600
...
for REMAINING_FILE in "$BASE_DIR"/*(N.); do
  ...
  if [[ "$REMAINING_EXTENSION" == "mp3" || "$REMAINING_EXTENSION" == "mp4" ]]; then
...
echo "Finished. The current folder has no remaining MP3 or MP4 files."
echo
